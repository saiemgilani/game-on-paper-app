...
export const COACH_BOARDS: Record<string, CoachBoard> = {
    ...
    scoring: {
        ...
        columns: [
            ...
            num('scripted_epa_per_play', 'Scripted EPA/Play', 'EPA per play on the opening scripted drives of each game', 'num2'),
            pct('scripted_success_rate', 'Scripted Success', 'Success rate on the opening scripted drives'),
            num('scripted_pts_per_drive', 'Scripted Pts/Drive', 'Points per drive on the opening scripted drives', 'num2'),
            num('non_scripted_epa_per_play', 'Unscripted EPA/Play', 'EPA per play on every drive after the opening script', 'num2'),
            num('non_scripted_pts_per_drive', 'Unscripted Pts/Drive', 'Points per drive after the opening script', 'num2'),
        ],
    },
    'fourth-downs': {
        slug: 'fourth-downs',
