    ...
    constructor(elementId, fieldColor = "rgb(0, 153, 41)", team1 = { color: "#B3A369", url: "https://a.espncdn.com/i/teamlogos/ncaa/500/59.png" }, team2 = { color: "#80000A", url: "https://a.espncdn.com/i/teamlogos/ncaa/500/60.png" }, baseLineWidth = 10, subtitle = null) {
        ...
        this.drawFieldLines = function () {
            ...
            for (var i = 0; i < 11; i++) {
                ...
                if ((i % 5) == 0) {
                    this.drawVerticalLine(this.fieldSegment + (i * this.fieldSegment), 0, this.fieldHeight, 5);
                } else {
                    this.drawVerticalLine(this.fieldSegment + (i * this.fieldSegment), 0, this.fieldHeight, 2);
                }
            ...
            this.drawLine(0, (this.fieldHeight / 2) - (goalpostWidth / 2), 0, (this.fieldHeight / 2) + (goalpostWidth / 2), 10, "yellow");
            this.drawLine(this.fieldWidth, (this.fieldHeight / 2) - (goalpostWidth / 2), this.fieldWidth, (this.fieldHeight / 2) + (goalpostWidth / 2), 10, "yellow");
        ...
        this.markPlay = function (color, startYardline, endYardline, text = null, annotation = null) {
            this.ctx.save();
            let startX = this.translateYardsToGoal(startYardline);
            let endX = this.translateYardsToGoal(endYardline);

            let capLength = (this.fieldSegment / 10) / 2;
            this.drawLine(startX, this.currentPlayY, endX - capLength, this.currentPlayY, this.playLineWidth, color);

            let capColor = (determineLuminance(color) > 0.5) ? "black" : "white";
            this.drawLine(endX - capLength, this.currentPlayY, endX, this.currentPlayY, this.playLineWidth, capColor);
            ...
            if (text) {
                ...
                this.drawRoundedRectText(text, minX, this.currentPlayY, "8px sans-serif", "#00000000", "white");
            }
