...
//     if (!payload.season && !payload.pctile) {
...
//         if (!payload.season) {
//             return [];
//         } else if ((payload.season >= 2014) && ((payload.season - 1) < maxLookback)) {
//             return [];
//         } else {
//             return await retrieveRemotePercentiles({year: payload.season - 1, pctile: payload.pctile }, maxLookback);
//         }
//     }
// }
