/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 5679ce52095a5fcc4766cda11ac07b5a)
// Runtime types generated with workerd@1.20260722.1 2026-05-24 global_fetch_strictly_public,nodejs_compat
interface __BaseEnv_Env {
	SDV_API_CACHE: KVNamespace;
	ASSETS: Fetcher;
	PYTHON_HTTP_URL: string;
	PYTHON_HTTP_TOKEN: string;
	SDV_AUTH_TOKEN: string;
	APP_VERSION: string;
	PYTHON_PROCESSOR: DurableObjectNamespace<import("../python/test").PythonProcessor>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("../python/test");
		durableNamespaces: "PythonProcessor";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PYTHON_HTTP_URL" | "PYTHON_HTTP_TOKEN" | "SDV_AUTH_TOKEN" | "APP_VERSION">> {}
}
