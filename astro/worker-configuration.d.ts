/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 8604eb15e27e4dc4c32264cb1fe5f68b)
// Runtime types generated with workerd@1.20260708.1 2026-05-24 global_fetch_strictly_public,nodejs_compat
interface __BaseEnv_Env {
	ASSETS: Fetcher;
	SUMMARY_HTTP_URL: string;
	PYTHON_HTTP_URL: string;
	SUMMARY: Fetcher /* game-on-paper-summary */;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SUMMARY_HTTP_URL" | "PYTHON_HTTP_URL">> {}
}
