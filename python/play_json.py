...
wp_start_touchback_columns = ["start.pos_team_receives_2H_kickoff","start.spread_time","start.half_seconds_remaining","start.game_seconds_remaining","start.ExpScoreDiff_Time_Ratio_touchback","start.pos_score_diff","start.down","start.distance","start.yardsToEndzone.touchback","start.is_home","start.posTeamTimeouts","start.defPosTeamTimeouts","period"]
wp_start_columns = ["start.pos_team_receives_2H_kickoff","start.spread_time","start.half_seconds_remaining","start.game_seconds_remaining","start.ExpScoreDiff_Time_Ratio","start.pos_score_diff","start.down","start.distance","start.yardsToEndzone","start.is_home","start.posTeamTimeouts","start.defPosTeamTimeouts","period"]
wp_end_columns = ["end.pos_team_receives_2H_kickoff","end.spread_time","end.half_seconds_remaining","end.game_seconds_remaining","end.ExpScoreDiff_Time_Ratio","end.pos_score_diff","end.down","end.distance","end.yardsToEndzone","end.is_home","end.posTeamTimeouts","end.defPosTeamTimeouts","period"]
    ...
    def cfb_pbp(self):
        ...
        * college-football/summary
        ...
        if 'drives' in pbp_txt.keys():
            ...
            pbp_txt['plays']['end.half_seconds_remaining'] = np.where(
                (pbp_txt['plays']['game_play_number'] == 1)|
                ((pbp_txt['plays']['half'] == "2") & (pbp_txt['plays']['lag_half'] == "1")),
                1800, pbp_txt['plays']['end.half_seconds_remaining']
            )
