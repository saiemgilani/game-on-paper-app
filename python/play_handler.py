...
class PlayProcess(object):
    ...
    def create_box_score(self):
        ...
        self.plays_json['EPA_success_pass'] = self.plays_json['EPA_success'].astype(float)
        self.plays_json['EPA_success_rush'] = self.plays_json['EPA_success'].astype(float)
